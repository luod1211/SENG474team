...
written to a tsv file, question_3b_output.tsv
'''
...
'''
This function performs stochastic gradient descent with 12 epochs
...
def main():
    ...
    output = open('./question_3b_output.tsv', "w")
    ...
    #write parameter results to a tsv file
    for i in range(D):
